...
import { initializeDatabase, dbGet, dbAll, dbRun } from './src/backend/db/init.js';
import authRoutes from './src/backend/routes/auth.js';
import userRoutes from './src/backend/routes/users.js';
import visitorRoutes from './src/backend/routes/visitors.js';
import eventRoutes from './src/backend/routes/events.js';
import preRegRoutes from './src/backend/routes/preRegistrations.js';
import reportRoutes from './src/backend/routes/reports.js';
import settingsRoutes from './src/backend/routes/settings.js';
